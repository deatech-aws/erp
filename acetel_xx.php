...
$query ="SELECT vMatricNo,CONCAT(vlastname,' ',vothernames) AS fname,vcityname AS Centre,
 iYrLevel,s.email,s.vPhoneNo,vProgaward,p.iMincredits,p.idecredit AS drcredits,p.ceductgid,s.cprogrammeid,entrymode
 FROM students s  INNER JOIN
 programme p ON p.cProgrammeID = s.cProgrammeID INNER JOIN
 studycenter c ON c.cStudyCenterId = s.cStudyCenterId
 AND vMatricNo =:matricno  where s.vMatricNo NOT in (select vMatricNo from misconduct_list)";
...
<body>
	...
	<div id="page-container" class="fade page-without-sidebar page-header-fixed">
      ...
      include "content/sor_detail.php";
      ?>
  		<!-- end #header -->
