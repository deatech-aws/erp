              ...
              $str="";
                $query="SELECT  cdepartmentid,departmentdesc
                  ...
                  while ($rw = $stmt->fetch(PDO::FETCH_NUM, PDO::FETCH_ORI_NEXT))
                  {
                    ...
                    echo "<li style \"width:150px\" ><a href=\"dept_sess.php?Returnurl=".enc($rw[0])."\"> ".$str."</a></li>";
                    $str="";
                  }
                  $stmt->closeCursor();
              ?>
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
              <li><a href="fac_ugcrs_stat">Under-Graduate</a></li>
							<li><a href="fac_crs_stat">Post-Graduate</a></li>
