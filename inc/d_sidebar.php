        ...
        <ul class="nav">
					<li class="nav-profile">
						...
						<?php echo $_SESSION['name']; ?>
							<small class="text-white">DEA Administrator</small>
						</div>
					</li>
				</ul>
				<!-- end sidebar user -->
				...
				<ul class="nav "  >
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
						    <li><a href="fac_dashboard">Main Dashboard</a></li>
              ...
              <?php
              $str="";
                $query="SELECT  p.cprogrammeid,vprogaward
                   FROM programme p INNER JOIN
                   department d ON d.cdepartmentid =p.cdepartmentid AND  d.cdepartmentid ='".$_SESSION['dept_id']."'";
              ...
              ?>
					...
					<li class="has-sub">
						<a href="javascript:;">
						    ...
						    <span>Course Statistic </span>
						</a>
						<ul class="sub-menu">
              <li><a href="dept_ugcrs_stat">Under-Graduate</a></li>
							<li><a href="dept_pgcrs_stat">Post-Graduate</a></li>
							<!-- <li><a href="v_ticket">Escalated Request</a></li>
							<li><a href="ui_tabs_accordions.html">Dispatched</a></li>
							<li><a href="ui_unlimited_tabs.html">Closed</a></li>
							<li><a href="ui_modal_notification.html">Unversified</a></li>
							<li><a href="ui_widget_boxes.html">Invalid</a></li> -->
