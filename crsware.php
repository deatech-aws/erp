...
$query="SELECT r.coursecode,coursetitle 
FROM resultsheet r INNER JOIN
availablecourse a ON a.coursecode=r.CourseCode 
AND vMatricNo ='".$_SESSION['matric_id']."'";
  // echo $query;
  $stmt = $conn->prepare($query, array(PDO::ATTR_CURSOR => PDO::CURSOR_FWDONLY));
  $stmt->execute();
...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		<!-- begin #header -->
	<?php
   include "content/crsware_details.php";
   ?>
