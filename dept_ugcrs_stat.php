...
FROM department
WHERE cdepartmentid='".$_SESSION['role_id']."'";
$fac_desc="";
...
<body class="boxed-layout">
    ...
    include "content/dept_ugcrs_stat_content.php";
    ?>
		<!-- end #header -->
  ...
  <div class="theme-panel" style="width:180px;margin-top:180px">
      ...
      <ul class="  text-white">
        <!-- <li class="arrow"></li> -->
        <li ><a class="text-white" href="javascript:;">Under-Graduate</a></li>
        <li ><a class="text-white" href="javascript:;">Post Graduate</a></li>
        <!-- <li><a href="javascript:;">Setting</a></li>
        <li class="divider"></li>
        <li><a href="." style="margin-left:30px"><i class="fa fa-sign-out"></i>Log Out</a></li> -->
      </ul>
    </div>
  </div>
