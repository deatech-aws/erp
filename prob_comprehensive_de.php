...
<div >
  ...
  <div class="login-buttons pull-right">
      <a class="btn btn-success btn-block btn-sm" href="#modal_grad_req" data-toggle="modal" data-backdrop="static" data-keyboard="false" style="margin-top:-20px"></i>View Graduation Requirement</a>
  </div>
  ...
  <div class="row" >
      <div class="panel panel-inverse" data-sortable-id="index-6">
        ...
        $query="SELECT t.vMatricNo,Name,Center,TCC,TCE,CGPE,CGPA,t.cProgrammeId,courses,entrylevel
          FROM tbl_details101022 t inner join
          students s ON s.vmatricno=t.vMatricNo AND t.cprogrammeid=:programmeid AND grad_approved=0";
          $stmt = $conn->prepare($query, array(PDO::ATTR_CURSOR => PDO::CURSOR_FWDONLY));
          ...
          while ($rw = $stmt->fetch(PDO::FETCH_NUM, PDO::FETCH_ORI_NEXT))
          {
            ...
            $dsc ="<div class = \"view_result\">
              <a href=\"rst_sess.php?Returnurl=".enc($rw[0])."\" target =\"_blank\"><b> ".$rw[1]."</b></a>
              <div class =\"pull-bottom\">
              <a class = \"viewresult btn btn-success\" target = \"_blank\" href=\"rst_sess.php?Returnurl=".enc($rw[0])."\">Review </a>
            ...
            echo"
              ...
              ";
          if ($comma_separated_out==""){
              echo "<td> ".$rw[0]."<br><b>".$is_De."</b><span class=\"text-center\"><i class =\"fa fa-4x fa-check \"><i/></span></td>
