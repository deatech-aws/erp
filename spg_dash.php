...
if (!isset($_SESSION["educat"])){
  $_SESSION["educat"]="PGX";
  $_SESSION['dsc'] ="Switch To Masters";
}

  $fac_desc="School of Postgraduate ";
...
$query ="SELECT c.cprogrammeid,COUNT(c.vmatricno) AS tot
  ...
  $query ="SELECT DISTINCT c.cprogrammeid
  FROM tbl_details c INNER JOIN
  programme p ON p.cprogrammeid=c.cprogrammeid AND ceductgid = '".$_SESSION['educat']."'";
...
<body>
    ...
    include "content/spg_dash_content.php";
    include "inc/spg_sidebar.php";
    include "inc/float_crs_pg.php";
    ?>
		<!-- end #header -->
