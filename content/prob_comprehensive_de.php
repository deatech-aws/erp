  ...
  <div class="row" >
      <div class="panel panel-inverse" data-sortable-id="index-6">
        ...
        $query="SELECT t.vMatricNo,Name,Center,TCC,TCE,CGPE,CGPA,t.cProgrammeId,courses,entrylevel
          ...
          while ($rw = $stmt->fetch(PDO::FETCH_NUM, PDO::FETCH_ORI_NEXT))
          {
            ...
            //Get the list of all passed courses
            $arrPCourse=array_diff($arrCourse,$arrFCourse);

            //Get the list of all password courses that is not a graduation creteria
            if(!is_null($core_arry) && count($core_arry)>0 ){
               $arrOut1 =array_diff($core_arry,$arrP);
            }
           

            //Get the list of failed and has not been passed
            if(count($arrOut1)>0){
               $arrOut =array_diff($arrOut1,$arrF);
            }
           

             //$arrOut =array_diff($arrOut,$arrP);
             if(!is_null($core_arry) && count($core_arry)>0){
            ...
            if(!is_null($arrOF) && Count($arrOF)>0){
               $comma_separated_arrOF=implode(",",$arrOF);
            }
           

            if(!is_null($arrOF) && count($arrFC)>0){
              $isStr=implode(",", $arrFC);
            }
            ...
            $dsc ="<div class = \"view_result\">
              ...
              <a class = \"viewresult btn_app btn btn-primary\" data-id =".$rw[0].">Approve Result</a>
            ...
            echo"
              <tr>
              ";
            //if ( $comma_separated_out=="" && $comma_separatedF==""){
            //if ( $comma_separated_out=="" ){
            
           if (empty($comma_separated_out) || $comma_separated_out=="" ){
             if(empty($isStr) || $isStr==""){
              ...
              echo "<td> ".$rw[0]." (".count($arrCourse).")<br><b>".$is_De."</b></td>
              <td style =\"width:200px\">
              ".$dsc1."</td>";
			      }
			else{
            ...
            echo "
                ...
                <td style=\"max-width:600px\">".$comma_separated."</td>
                <td style=\"max-width:400px\">".$isStr."</td>
    ...
    if($cTotal==0){
     $t_grad=0;
      ...
      $t_grad=$t_grad/$cTotal;
      $t_fail=$t_fail/$cTotal;
      $t_out= $t_out/$cTotal;
      $t_both=$t_both/$cTotal;
      $t_only_out=$t_only_out/$cTotal;
      $t_only_fail=$t_only_fail/$cTotal;
    }
    ?>
        <div class="row tile_count">
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <!-- <span class="count_top"><i class="fa fa-users"></i> Met Graduation Creteria</span> -->
              <div  class="count text-info"><?php echo number_format($t_grad*100,"2");?>%</div>
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <div  class="count text-danger"><?php echo number_format($t_fail*100,"2"); ?>%</div>
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <div  class="count text-warning"><?php echo number_format($t_out*100,"2"); ?>%</div>
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <div  class="count"><?php echo number_format($t_both*100,"2"); ?>%</div>
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <div class="count text-primary"><?php echo number_format($t_only_out*100,"2"); ?>%</div>
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <div class="count text-success"><?php echo number_format($t_only_fail*100,"2"); ?>%</div>
