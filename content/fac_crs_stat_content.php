<!-- begin #content -->
<?php
$query ="SELECT t.coursecode,coursetitle,creditunit,ilevel,f+i as fail,D+C+B+A AS pass
         FROM tbl_course_performance t inner join
         availablecourse a ON a.coursecode =t.coursecode AND cfacultyid ='".$_SESSION['fac_id']. "' AND ilevel>500";
  ...
  <div class="row">
      <div class="panel panel-inverse" data-sortable-id="index-6">
        <div class="panel-heading">
          ...
          <h1 class="panel-title" style="font-size:14px"><?php echo $_SESSION['sess'] ?>  Faculty Post-Graduate Course Statistics</h1>
        </div>
