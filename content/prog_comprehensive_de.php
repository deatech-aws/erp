...
$query="SELECT
    ...
    HAVING cprogrammeid='".$_SESSION['prog_id']."' AND batchno='2016_2' AND iYrlevel=".$_SESSION['lev_id'];
  // echo $query;
...
<div id="content" class="content" style="margin-top:0px">
  ...
  <h1 class="page-header"><?php echo $desc.' '.$prog_desc; ?> Result Analytics Dashboard <small>Academic Performance Distribution...</small></h1>
  <!-- end page-header -->
  ...
  <div class="row">
      <div class="panel panel-inverse" data-sortable-id="index-6">
        <div class="panel-heading">
          ...
          <h1 class="panel-title" style="font-size:14px">Result Sheet of <?php echo $desc."  Courses of ".$prog_desc; ?> for 2021_1 Academic Session  </h1>
        </div>
            ...
            for ($i=0;$i<=COUNT($cum_arry)-1;$i++)
             {
               ...
               if (COUNT($result)>1){
                ...
                for ($a=0;$a<=COUNT($result)-1;$a++)
                {
                  ...
                  // echo "<td class=\"text-center\">".$rec[1]."<br>(".$rec[2].")</td>";
