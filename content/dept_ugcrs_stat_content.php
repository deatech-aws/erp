<!-- begin #content -->
<?php
$query ="SELECT t.coursecode,coursetitle,F as fail,E+D+C+B+A AS pass,i as incomplete
         FROM tbl_course_performance t inner join
         availablecourse a ON a.coursecode =t.coursecode AND cfacultyid ='S' AND ilevel<=500
         AND F+D+C+B+A>0";

 $query ="SELECT t.coursecode,coursetitle,creditunit,ilevel,f as fail,E+D+C+B+A AS pass, i as incomplete
          FROM tbl_course_performance t inner join
          availablecourse a ON a.coursecode =t.coursecode 
           AND a.cdepartmentid ='".$_SESSION['dept_id']. "' AND ilevel<=500 AND F+E+D+C+B+A+I>0";
...
<div id="content" class="content" style="margin-top:30px">
  ...
  <div class="row tile_count responsive">
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
        <span class="count_top"><i class="fa fa-user"></i><b> Incomplete</b></span>
        <div class="count text-warning"><?php echo number_format($i_count,"0"); ?></div>
      </div>
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
       ...
       <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
        <span class="count_top"><i class="fa fa-user"></i> % Incomplte</span>
        <div class="count text-primary"><?php echo number_format(($i_count/$ttal)*100,"2"); ?>%</div>
      </div>
  ...
  <div class="row">
    <div class="panel panel-inverse" data-sortable-id="index-6">
      <div class="panel-heading">
        ...
        <h1 class="panel-title" style="font-size:14px"><?php echo $_SESSION['sess'];?> Departments Under-Graduate Course Statistics</h1>
      </div>
