<!-- begin #content -->
<?php
$query ="SELECT t.coursecode,coursetitle,creditunit,ilevel,f as fail,D+C+B+A AS pass
         FROM tbl_course_performance t inner join
         availablecourse a ON a.coursecode =t.coursecode  AND ilevel>500";
...
<div id="content" class="content" style="margin-top:30px">
  ...
  <div class="row tile_count responsive">
      <div class="col-md-2 col-sm- col-xs-6 tile_stats_count">
        ...
        <div class="count text-info"><?php echo number_format($f_count+$p_count,"0"); ?></div>
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
        ...
        <div class="count"><?php echo number_format(($f_count/($f_count+$p_count))*100,"2"); ?>%</div>
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
        ...
        <div class="count text-primary"><?php echo number_format(($f_count/($p_count+$p_count))*100,"2"); ?>%</div>
  ...
  <div class="row">
      <div class="panel panel-inverse" data-sortable-id="index-6">
        <div class="panel-heading">
          ...
          <h1 class="panel-title" style="font-size:14px">Faculty Post-Graduate Course Statistics</h1>
        </div>
