...
$query="SELECT SUM(fail) AS fail,SUM(third_class) AS third_class,
  ...
  HaVING cfacultyid='".$_SESSION['fac_id']."' AND batchno = '".$_SESSION['sess']."'";
//  echo $query;
//  exit;
  ...
  $ndUPerc=($ndU/$cTotal)*100;
  $ndLPerc=($ndL/$cTotal)*100;
  $stCPerc=($stC/$cTotal)*100;
  }
...
<div id="content" class="content" style="margin-top:30px">
  ...
  <div class="row tile_count">
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
        ...
        <div class="count text-danger"><?php echo  number_format($failPerc,"2"); ?>%</div>
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
        ...
        <div class="count text-warning"><?php echo number_format($rdCPerc,"2"); ?>%</div>
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
        ...
        <div class="count"><?php echo number_format($ndLPerc,"2"); ?>%</div>
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
        ...
        <div class="count text-primary"><?php echo number_format($ndUPerc*100,"2"); ?>%</div>
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
        ...
        <div class="count text-success"><?php echo number_format($stCPercl*100,"2"); ?>%</div>
  ...
  <div class="row">
        <div class="widget-chart with-sidebar ">
            <div class="widget-chart-content" style="margin-top:-30px">
                <h3 class="text-black">
                    ...
                    <small>Graphical Performance Distribution Chart...</small>
                </h3>
            ...
            <div class="widget-chart-sidebar bg-grey">
              <div class="chart-number">
                ...
                <ul class="pull-left" style="font-size:14px">
                    <i class="fa fa-circle fa-fw text-danger f-s-9 m-r-5 t-minus-1"></i> <?php echo number_format($failPerc,"2"); ?><span> Probation List</span></br>
                    <i class="fa fa-circle fa-fw text-inverse f-s-9 m-r-5 t-minus-1"></i> <?php echo number_format($rdCPerc,"2") ?>% <span>3<sup>rd</sup> Class</span></br>
                    <i class="fa fa-circle fa-fw text-primary f-s-9 m-r-5 t-minus-1"></i> <?php echo number_format($ndLPerc,"2") ?>% <span>2<sup>nd</sup> Class <i class="fa fa-long-arrow-down"></i></span></br>
                    <i class="fa fa-circle fa-fw text-info f-s-9 m-r-5 t-minus-1"></i> <?php echo number_format($ndUPerc,"2") ?>% <span>2<sup>nd</sup> Class <i class="fa fa-long-arrow-up"></i></span></br>
                    <i class="fa fa-circle fa-fw text-success f-s-9 m-r-5 t-minus-1"></i> <?php echo number_format($stCPerc,"2") ?>% <span>1<sup>st</sup> Class </span>
                </ul>
            </div>
        </div>
      <!-- </div> -->
    ...
    <!-- <div class="col-md-4"> -->
      ...
      $query="SELECT c.cprogrammeid,vprogaward,
                ...
                HAVING c.cfacultyid='".$_SESSION['fac_id']."' AND batchno = '".$_SESSION['sess']."'";
              // echo $query;
                   $stmt = $conn->prepare($query, array(PDO::ATTR_CURSOR => PDO::CURSOR_FWDONLY));
                   $stmt->execute();
                   $j=0;
                           ...
                           <div class = \"view_result\">
                             <a><b> ".$rw[1]."</b></a>
                              ...
                              if($rw[8]=="PGX"){
                                ...
                                <a class = \"viewresult btn btn-primary btn-xs\" target = \"_blank\" href=\"prob_sess.php?Returnurl=".enc($rw[0])."\" >Probable Graduant</a>
                                ";
                              }elseif($rw[8]=="PGY"){
                                echo"
                                <a class = \"viewresult btn btn-warning btn-xs\" target = \"_blank\" href=\"p_lev_sess.php?Returnurl=".enc($rw[0].'|800')."\" >Master List</a>
                                <a class = \"viewresult btn btn-primary btn-xs\" target = \"_blank\" href=\"prob_sess.php?Returnurl=".enc($rw[0].'|800')."\" >Probable Graduant</a>
                                ";
                              }else{
                                for ($i=1;$i<=$rw[9];$i++){
                                ...
                                $i--;
                                echo "<a class = \"viewresult btn btn-primary btn-xs\" target = \"_blank\" href=\"prob_sess.php?Returnurl=".enc($rw[0].'|'.$i*100)."\" >Probable Graduant</a>";
                              }
                                 echo "
                               </div>
                            </div>
