        ...
        <div class="login login-v2" data-pageload-addclass="animated fadeIn" style="margin-top:5%!important">
            ...
            <div class="login-content">
								<!-- <div class="m-t-20 m-b-40 p-b-40 text-white"> -->
									...
									<h3 class="text-white"> Help Desk Support Centre</h3>
										<p> Search and relay feedback on students result issues</p>
									</div>
								<!-- </div> -->
								<hr>
								<!-- <form class=" full-width" action="m_sess.php"> -->
									...
									<div class="login-buttons">
											<button id="hd_submit" class="btn btn-success btn-block btn-lg">Search...</button>
									</div>
								<!-- </form> -->
